...
//! `rr2` — in-place regex substitution using grouse's normalised-view infrastructure.
//!
//! Usage (file mode):
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // ── open with grouse to detect encoding and line-ending ───────────────────
